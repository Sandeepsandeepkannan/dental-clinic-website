...
import { Award, ShieldCheck, Activity, Users, MapPin, Microscope, HeartPulse } from "lucide-react";
...
export default function DentalInfoSectionpage() {
  ...
  return (
    // Section Background: Slate-50 (Steel Gray base)
    <section className="bg-slate-50 py-24 md:py-32 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32 items-center">
          ...
          <div className="lg:col-span-5 space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="p-5 bg-white rounded-2xl shadow-sm border border-slate-100 group hover:border-blue-200 transition-colors">
                <p className="text-2xl font-serif text-slate-900 group-hover:text-blue-700 transition-colors">Invisalign</p>
                <p className="text-xs text-blue-600 font-bold uppercase tracking-widest">Platinum Center</p>
              </div>
              <div className="p-5 bg-white rounded-2xl shadow-sm border border-slate-100 group hover:border-blue-200 transition-colors">
                <p className="text-2xl font-serif text-slate-900 group-hover:text-blue-700 transition-colors">Digital</p>
                <p className="text-xs text-blue-600 font-bold uppercase tracking-widest">Guided Care</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 animate-in fade-in slide-in-from-right-8 duration-1000 delay-200">
            <div className="relative group">
              ...
              {/* Card: Pure White with Gray shadow */}
        ...
        <div className="space-y-16">
          ...
          {/* Experts Grid: White cards with Blue highlights */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {expertCategories.map((item, idx) => (
              ...
              >
                {/* Icon Circle: Slate-900 with Blue icon */}
          ...
          {/* Bottom Statement: Deep Navy/Slate-900 with Blue glow */}
          <div className="bg-slate-900 rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden mt-12">
            ...
            <p className="relative z-10 text-white text-lg md:text-xl font-light max-w-4xl mx-auto leading-relaxed">
              In addition to our primary specialists, our team includes highly skilled <span className="text-blue-400 font-medium italic underline decoration-blue-400/30">Periodontists</span> who collaborate to ensure comprehensive oral health for every patient.
            </p>
          </div>
        </div>
