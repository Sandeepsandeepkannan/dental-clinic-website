...
function Navbar() {
  ...
  const triggerChat = () => {
    const event = new CustomEvent("open-aesthetiq-chat");
    ...
    <>
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-500 ease-in-out border-b ${
          isScrolled
            ? "bg-black/95 backdrop-blur-xl py-3 border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.5)]"
            : "bg-black py-4 md:py-5 border-white/5"
        }`}
      >
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className="relative w-10 h-10 md:w-12 md:h-12 transition-all duration-500 group-hover:scale-110">
                ...
                <Image
                  ...
                  className="object-contain rounded-xl md:rounded-2xl relative z-10 brightness-110"
                  priority
                />
              </div>
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              <button
                ...
                className="group relative px-8 py-3 bg-blue-700 text-white font-black text-[10px] uppercase tracking-[0.2em] rounded-full overflow-hidden transition-all hover:shadow-[0_10px_25px_rgba(30,64,175,0.4)]"
              >
        ...
        >
          <div className="flex flex-col h-full p-6 sm:p-10 overflow-y-auto">
            ...
            <div className="mt-auto pt-10 pb-6 space-y-4">
               <button
                onClick={triggerChat}
                className="w-full flex items-center justify-center gap-3 border border-blue-500/30 bg-blue-500/10 text-blue-400 py-5 rounded-2xl font-black uppercase tracking-widest text-xs"
              >
              ...
              <button
                ...
                className="w-full bg-blue-700 text-white py-5 rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl shadow-blue-900/40"
              >
