            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-100">
                <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-light italic">
                  ...
                  </span>, is a premier center for Braces & Invisalign in Anna Nagar.
                  We blend clinical excellence with compassionate care to offer
                  personalized, digitally guided smile corrections."
                </p>
        ...
        <div className="space-y-16">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto font-light pt-4">
              Our multidisciplinary team is dedicated to patient betterment
              through specialized surgical and therapeutic skills.
            </p>
          </div>
          ...
          <div className="bg-slate-900 rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <p className="relative z-10 text-white text-lg md:text-xl font-light max-w-3xl mx-auto leading-relaxed italic">
              "Our team includes highly skilled{" "}
              <span className="text-blue-400 font-medium">
                Periodontists
              </span>{" "}
              and surgeons who dedicate their skills to the betterment of our
              patients across Chennai."
            </p>
          </div>
        </div>
