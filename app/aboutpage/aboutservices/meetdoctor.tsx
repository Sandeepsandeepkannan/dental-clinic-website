    ...
    <section className="bg-slate-50 py-24 md:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-20 relative">
          ...
          <div className="w-16 h-1 bg-blue-700 mx-auto rounded-full animate-in fade-in duration-1000 delay-500"></div>
        </div>
          ...
          {doctors.map((doctor) => (
            ...
            >
              ...
              <div className="relative w-full aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-white mb-8 shadow-lg transition-all duration-500 group-hover:shadow-2xl group-hover:-translate-y-2 border border-slate-100">
                ...
                {/* Social Overlay: Blue-900 with White Glassmorphism */}
                <div className="absolute inset-x-0 bottom-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out z-20">
                  <div className="bg-white/90 backdrop-blur-md rounded-2xl p-4 flex justify-around items-center shadow-xl border border-slate-100">
                    <a href="#" className="p-2 text-slate-600 hover:text-blue-700 transition-all hover:scale-110"><Linkedin size={20} /></a>
                    <a href="#" className="p-2 text-slate-600 hover:text-blue-700 transition-all hover:scale-110"><Twitter size={20} /></a>
                    <a href="#" className="p-2 text-slate-600 hover:text-blue-700 transition-all hover:scale-110"><Instagram size={20} /></a>
                  </div>
                </div>

                {/* Plus Icon: Royal Blue with White Glow */}
        ...
        {/* Bottom Call to Action: Slate-900 base with Blue hover */}
        <div className="mt-20 text-center">
            <button className="px-10 py-4 bg-slate-900 text-white font-bold rounded-xl transition-all hover:bg-blue-700 hover:shadow-2xl active:scale-95 uppercase text-xs tracking-[0.2em]">
