        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32 items-center">
          ...
          <div className="lg:col-span-5 space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
            ...
            <h2 className="text-4xl md:text-6xl font-serif text-slate-900 leading-tight">
              About <span className="text-blue-700 italic font-medium">Sculpt</span> <br />
              Dental Hospital
            </h2>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              <div className="p-5 bg-white rounded-2xl shadow-sm border border-slate-100 group hover:border-blue-200 transition-colors">
                <Microscope size={24} className="text-blue-700 mb-3" aria-hidden="true" />
              ...
              <div className="p-5 bg-white rounded-2xl shadow-sm border border-slate-100 group hover:border-blue-200 transition-colors">
                <ShieldCheck size={24} className="text-blue-700 mb-3" aria-hidden="true" />
          ...
          <div className="lg:col-span-7 animate-in fade-in slide-in-from-right-8 duration-1000 delay-200">
            <div className="relative group">
              ...
              <div className="relative bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-100">
                <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-light first-letter:text-5xl first-letter:font-serif first-letter:text-blue-700 first-letter:mr-3 first-letter:float-left">
                  SCULPT Dental Hospital, led by renowned orthodontist{" "}
                  <span className="text-slate-900 font-medium">
                    Dr. Sanjay Sundararajan
                  </span>
                  , is a premier center for Braces & Invisalign in Anna Nagar. We offer personalized, digitally guided smile corrections with a primary focus on aesthetics, comfort, and precision.
                </p>
        ...
        <div className="space-y-16">
          ...
          <div className="bg-slate-900 rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <p className="relative z-10 text-white text-lg md:text-xl font-light max-w-3xl mx-auto leading-relaxed italic">
              "Our dentists are skilled at performing a wide range of procedures,
              dedicating their specialized skills as periodontists and surgeons to
...
export default React.memo(Dental);
