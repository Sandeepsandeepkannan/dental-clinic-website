...
import { Award, ShieldCheck, Activity, Users, ClipboardCheck, Microscope } from "lucide-react";

export default function Dental() {
  return (
    // Section Background: Slate-50 (Very light gray) for a clean, airy feel
        ...
        <div className="space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { title: "Implantologists", icon: <ClipboardCheck />, desc: "Experts in permanent dental restoration and implants." },
          ...
          {/* Quote Block: Deep Navy/Slate-900 */}
