...
import { Mail, MapPin, Clock, Facebook, Instagram, Linkedin, MessageCircle, Phone } from "lucide-react";

export default function Footernew() {
  const currentYear = new Date().getFullYear();
  const whatsappNumber = "8190027273";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.3em] text-blue-400 font-bold">Foundation</p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <a href={`https://wa.me/91${whatsappNumber}`} target="_blank" className="hover:text-green-400 transition-all transform hover:scale-110">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              {["About us", "Our services", "Blog", "Contact us"].map((link) => (
                <li key={link}>
                  <Link href={`/${link.toLowerCase().replace(" ", "")}`} className="text-sm hover:text-blue-400 hover:translate-x-2 transition-all inline-block">
                    {link}
                  </Link>
                </li>
              ))}
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-serif text-white border-b border-white/10 pb-4">Contact Us</h3>
            <div className="space-y-6">
              {/* WhatsApp Connection */}
              <div className="flex items-center gap-3 group">
                ...
                <a href={`https://wa.me/91${whatsappNumber}`} target="_blank" className="text-sm hover:text-green-500 transition-colors font-bold">
